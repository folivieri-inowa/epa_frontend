...
export default function HomeSeparatorBanner3() {
  ...
  return (
    <Box
      ...
      sx={{
        ...
        backgroundImage: 'url(/assets/images/roadmap3.png)',
      ...
      <Container>
        ...
        >
          <m.div variants={varFade().inUp}>
            ...
            >
              {t('home.separator_banner_3.title', 'La sicurezza non è un prodotto, ma un processo continuo di evoluzione e miglioramento')}
            </Typography>
          </m.div>

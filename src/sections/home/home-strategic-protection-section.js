...
export default function HomeStrategicProtectionSection() {
          ...
          >
            <Box sx={{ maxWidth: 480, textAlign: 'center' }}>
              <m.div variants={varFade().inUp}>
                ...
                >
                  {t('home.strategic_protection_section.title')}
                </Typography>
              </m.div>
              ...
              <m.div variants={varFade().inUp}>
                ...
                >
                  {t('home.strategic_protection_section.description')}
                </Typography>
              </m.div>
              ...
              <m.div variants={varFade().inUp}>
                <Button
                  ...
                  href={paths.protezione_strategica}
                  color="primary"
                  size="large"
                  variant="contained"
                ...
                >
                  {t('home.strategic_protection_section.button')}
                </Button>
              </m.div>
            </Box>
          </Box>
